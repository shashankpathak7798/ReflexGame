...
public class Grid4X4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_grid4_x4, container, false);
        ...
        switch(no) {
            ...
            case 10:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn10.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn10.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn10.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 11:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn11.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn11.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn11.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 12:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn12.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn12.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn12.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 13:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn13.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn13.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn13.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 14:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn14.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn14.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn14.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 15:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn15.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn15.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn15.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
            ...
            case 16:
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        btn16.setBackgroundResource(R.drawable.button_color);
                        final long time = System.currentTimeMillis();
                        btn16.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                                long time1 = System.currentTimeMillis();
                                btn16.setBackgroundResource(R.drawable.round_button);
                                Intent intent = new Intent(getContext(), EndGame.class);
                                intent.putExtra("responseTime", time1-time);
                                startActivity(intent);
                            }
